...
@Configuration
@EnableJpaRepositories("beichuk.ua.remindme.server.repository")
...
public class DatabaseConfig
{
    ...
    public DataSource dataSource()
    {
        ...
        ds.setTestOnBorrow(Boolean.valueOf(env.getRequiredProperty("db.testOnBorow")));
    ...
    public Properties getHibernateProperties()
    {
        ...
        {
            throw new IllegalArgumentException("Can't finde 'hibernate.properties' in cpasspath!", e);
        }
    }
}
